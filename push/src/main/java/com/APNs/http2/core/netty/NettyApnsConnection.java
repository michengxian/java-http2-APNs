package com.APNs.http2.core.netty;


import com.APNs.http2.core.model.PushNotification;
import com.APNs.http2.core.netty.http2.Http2ClientInitializer;
import com.APNs.http2.core.netty.http2.Http2SettingsHandler;
import com.APNs.http2.core.netty.http2.HttpResponseHandler;
...
//                } catch (Exception e) {
//                    log.com.APNs.http2.core.error("initializeNettyClient", e);
...
//                    log.com.APNs.http2.core.error("close channel", e);
//                }
//            }
//        }
//
//        if (!success) {
//            log.com.APNs.http2.core.error("send failed token " + notification.getToken() + ", size:" + http2ClientInitializer.responseHandler().notificationMap.size());
//        }
//    }
